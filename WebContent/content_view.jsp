        ...
        <div class="row">
                <table class="table table-striped"
                   ...
                   <thead>
                        <tr>
                            <th colspan="3"
                                style="background-color: #eeeeee; text-align: center;">자유게시판 글</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                ...
                <a href = "freeboard_view.do" class="btn btn-primary">목록</a>          
                    <%
                //글작성자 본인일시 수정 삭제 가능
                    if(userId.equals(session.getAttribute("contentId")) || userId.equals("admin")){
                    %>
                        <a href="modify_view.do?bId=${content_view.bId}" class="btn btn-primary">수정</a>
                        <a onclick="return confirm('정말로 삭제하시겠습니까?')" href="delete.do?bId=${content_view.bId}" class="btn btn-primary">삭제</a>
                    <%                  
                    }
                    %>
        </div>
