...
<!-- 네비게이션  -->
    ...
    <div class="container">
        <div class="row">
            <form action = "PEP" method = "post" enctype = "multipart/form-data">
            <input type = "hidden" value = "<%=userId %>">
                <table class="table table-striped"
                    ...
                    <thead>
                        <tr>
                            <th colspan="2"
                                style="background-color: #eeeeee; text-align: center;">매물 등록</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td><input type="text" class="form-control" placeholder="기종" name="pName" maxlength="30"/></td>
                        </tr>
                         <tr>
                         <tr>
                            <td><input type="text" class="form-control" placeholder="통신사" name="pTTC" maxlength="30"/></td>
                        </tr>
                            <td><input type="text" class="form-control" placeholder="가격" name="pPrice" maxlength="30"/></td>
                        </tr>
                         <tr>
                            <td>
                         ...
                         <tr>
                            <td><input type="text" class="form-control" placeholder="휴대폰 번호" name="pPhoneNumber" maxlength="30"/></td>
                        </tr>
                    </tbody>
                </table>    
