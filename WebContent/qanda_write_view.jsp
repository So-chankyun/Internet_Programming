...
<!-- 네비게이션  -->
	...
	<div class="container">
		<div class="row">
			<form action = "qanda_writeAction.qdo">
				<table class="table table-striped"
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="qTitle" maxlength="30"/></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="qContent" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
				</table>	
